...
def take_action(regions):
    ...
    state_description = ''
    if wall:
        if regions['fright'] < d*3/4: #obstaculo delante - derecha
            state_description = 'case 2 - fright'
            linear_x = 0
            angular_z = +wz * vf
        elif regions['bright'] < d*3/4: #
            state_description = 'case 5 - bright'
            linear_x = 0
            angular_z = +wz* vf
        elif regions['fleft'] < d*3/4: #obstaculo delante - izquierda
            state_description = 'case 6 - fleft'
            linear_x = 0
            angular_z = +wz* vf
        elif regions['bleft'] < d*3/4: 
        ...
        else: #no hay obstaculos - implica que hemos perdido la pared, esto solo puede pasar si hay un giro brusco y no hay pared
